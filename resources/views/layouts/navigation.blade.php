  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-evenly h-20">
      <div class="flex">
        ...
        <!-- 🔽 作成ページへのリンクを追加 -->
        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
          <x-nav-link :href="route('question.create')" :active="request()->routeIs('question.create')">
            {{ __('質問する') }}
          </x-nav-link>
        </div>
        <!-- 🔽 マイページへのリンクを追加 -->
      ...
      <div class="hidden sm:flex sm:items-right sm:ml-6">
        <x-dropdown align="right" width="48">
          <x-slot name="trigger">
            <button class="flex place-items-center text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
          ...
          <x-slot name="content">
            ...
            <form method="GET" action="{{ route('user.index') }}">
              ...
              <x-dropdown-link :href="route('user.index')" onclick="event.preventDefault();
